@if (Auth::check())
    ...
    <table width="100%" >
        ...
        <tr>
            ...
            <td>{{$kolom1= ($formulir->kolom_volume != 0) ? number_format($formulir->kolom_tahap2a/$formulir->kolom_volume*$satu, 2, '.', '') : 0}}</td>
            <td>{{$kolom2= ($formulir->kolom_volume != 0) ? number_format($formulir->kolom_tahap2b/$formulir->kolom_volume*$dua, 2, '.', '') : 0}}</td>
            <td>{{$kolom3= ($formulir->kolom_volume != 0) ? number_format($formulir->kolom_tahap2c/$formulir->kolom_volume*$tiga, 2, '.', '') : 0}}</td>
            <td>{{$kolom4= ($formulir->kolom_volume != 0) ? number_format($formulir->kolom_tahap2d/$formulir->kolom_volume*$empat, 2, '.', '') : 0}}</td>
            <td>{{$kolom5= ($formulir->kolom_volume != 0) ? number_format($formulir->kolom_tahap2e/$formulir->kolom_volume*$lima, 2, '.', '') : 0}}</td>
            <td>{{$kolom6= ($formulir->kolom_volume != 0) ? number_format($formulir->kolom_tahap2f/$formulir->kolom_volume*$enam, 2, '.', '') : 0}}</td>
            <td>{{$kolom7= ($formulir->kolom_volume != 0) ? number_format($formulir->kolom_tahap2g/$formulir->kolom_volume*$tujuh, 2, '.', '') : 0}}</td>
        ...
        <tr>
            ...
            <td>{{$balok1= ($formulir->balok_volume != 0) ? number_format($formulir->balok_tahap2a/$formulir->balok_volume*$satu, 2, '.', '') : 0}}</td>
            <td>{{$balok2= ($formulir->balok_volume != 0) ? number_format($formulir->balok_tahap2b/$formulir->balok_volume*$dua, 2, '.', '') : 0}}</td>
            <td>{{$balok3= ($formulir->balok_volume != 0) ? number_format($formulir->balok_tahap2c/$formulir->balok_volume*$tiga, 2, '.', '') : 0}}</td>
            <td>{{$balok4= ($formulir->balok_volume != 0) ? number_format($formulir->balok_tahap2d/$formulir->balok_volume*$empat, 2, '.', '') : 0}}</td>
            <td>{{$balok5= ($formulir->balok_volume != 0) ? number_format($formulir->balok_tahap2e/$formulir->balok_volume*$lima, 2, '.', '') : 0}}</td>
            <td>{{$balok6= ($formulir->balok_volume != 0) ? number_format($formulir->balok_tahap2f/$formulir->balok_volume*$enam, 2, '.', '') : 0}}</td>
            <td>{{$balok7= ($formulir->balok_volume != 0) ? number_format($formulir->balok_tahap2g/$formulir->balok_volume*$tujuh, 2, '.', '') : 0}}</td>
        ...
        <tr>
            ...
            <td>{{$kusen1= ($formulir->kusen_volume != 0) ? number_format($formulir->kusen_tahap2a/$formulir->kusen_volume*$satu, 2, '.', '') : 0}}</td>
            <td>{{$kusen2= ($formulir->kusen_volume != 0) ? number_format($formulir->kusen_tahap2b/$formulir->kusen_volume*$dua, 2, '.', '') : 0}}</td>
            <td>{{$kusen3= ($formulir->kusen_volume != 0) ? number_format($formulir->kusen_tahap2c/$formulir->kusen_volume*$tiga, 2, '.', '') : 0}}</td>
            <td>{{$kusen4= ($formulir->kusen_volume != 0) ? number_format($formulir->kusen_tahap2d/$formulir->kusen_volume*$empat, 2, '.', '') : 0}}</td>
            <td>{{$kusen5= ($formulir->kusen_volume != 0) ? number_format($formulir->kusen_tahap2e/$formulir->kusen_volume*$lima, 2, '.', '') : 0}}</td>
            <td>{{$kusen6= ($formulir->kusen_volume != 0) ? number_format($formulir->kusen_tahap2f/$formulir->kusen_volume*$enam, 2, '.', '') : 0}}</td>
            <td>{{$kusen7= ($formulir->kusen_volume != 0) ? number_format($formulir->kusen_tahap2g/$formulir->kusen_volume*$tujuh, 2, '.', '') : 0}}</td>
        ...
        <tr>
            ...
            <td>{{$pintu1= ($formulir->pintu_volume != 0) ? number_format($formulir->pintu_tahap2a/$formulir->pintu_volume*$satu, 2, '.', '') : 0}}</td>
            <td>{{$pintu2= ($formulir->pintu_volume != 0) ? number_format($formulir->pintu_tahap2b/$formulir->pintu_volume*$dua, 2, '.', '') : 0}}</td>
            <td>{{$pintu3= ($formulir->pintu_volume != 0) ? number_format($formulir->pintu_tahap2c/$formulir->pintu_volume*$tiga, 2, '.', '') : 0}}</td>
            <td>{{$pintu4= ($formulir->pintu_volume != 0) ? number_format($formulir->pintu_tahap2d/$formulir->pintu_volume*$empat, 2, '.', '') : 0}}</td>
            <td>{{$pintu5= ($formulir->pintu_volume != 0) ? number_format($formulir->pintu_tahap2e/$formulir->pintu_volume*$lima, 2, '.', '') : 0}}</td>
            <td>{{$pintu6= ($formulir->pintu_volume != 0) ? number_format($formulir->pintu_tahap2f/$formulir->pintu_volume*$enam, 2, '.', '') : 0}}</td>
            <td>{{$pintu7= ($formulir->pintu_volume != 0) ? number_format($formulir->pintu_tahap2g/$formulir->pintu_volume*$tujuh, 2, '.', '') : 0}}</td>
        ...
        <tr>
            ...
            <td>{{$jendela1= ($formulir->jendela_volume != 0) ? number_format($formulir->jendela_tahap2a/$formulir->jendela_volume*$satu, 2, '.', '') : 0}}</td>
            <td>{{$jendela2= ($formulir->jendela_volume != 0) ? number_format($formulir->jendela_tahap2b/$formulir->jendela_volume*$dua, 2, '.', '') : 0}}</td>
            <td>{{$jendela3= ($formulir->jendela_volume != 0) ? number_format($formulir->jendela_tahap2c/$formulir->jendela_volume*$tiga, 2, '.', '') : 0}}</td>
            <td>{{$jendela4= ($formulir->jendela_volume != 0) ? number_format($formulir->jendela_tahap2d/$formulir->jendela_volume*$empat, 2, '.', '') : 0}}</td>
            <td>{{$jendela5= ($formulir->jendela_volume != 0) ? number_format($formulir->jendela_tahap2e/$formulir->jendela_volume*$lima, 2, '.', '') : 0}}</td>
            <td>{{$jendela6= ($formulir->jendela_volume != 0) ? number_format($formulir->jendela_tahap2f/$formulir->jendela_volume*$enam, 2, '.', '') : 0}}</td>
            <td>{{$jendela7= ($formulir->jendela_volume != 0) ? number_format($formulir->jendela_tahap2g/$formulir->jendela_volume*$tujuh, 2, '.', '') : 0}}</td>
        ...
        <tr>
            ...
            @php
                ...
                $drainasetdk=0;
            @endphp
            @if ($formulir->drainaselimbah_volume=0)
                    $drainasevol=1;
                    $drainasetdk=1;
            @else
                    $drainasevol=$formulir->drainaselimbah_volume;
                    $drainasetdk=$formulir->drainaselimbah_tahap2a;
            @endif
            <td> {{$drainasevol}} </td>
            <td></td>
            <td>{{$drainasetdk}}</td>
            ...
            <td>{{$drainaselimbah1 = ($drainasevol != 0) ? number_format($drainasetdk / $drainasevol * $satu, 2, '.', '') : 0}}</td>
            <td>{{$drainaselimbah2 = ($drainasevol != 0) ? number_format($formulir->drainaselimbah_tahap2b / $drainasevol * $dua, 2, '.', '') : 0}}</td>
            <td>{{$drainaselimbah3= ($drainasevol != 0) ? number_format($formulir->drainaselimbah_tahap2c/$drainasevol*$tiga, 2, '.', '') : 0}}</td>
            <td>{{$drainaselimbah4= ($drainasevol != 0) ? number_format($formulir->drainaselimbah_tahap2d/$drainasevol*$empat, 2, '.', '') : 0}}</td>
            <td>{{$drainaselimbah5= ($drainasevol != 0) ? number_format($formulir->drainaselimbah_tahap2e/$drainasevol*$lima, 2, '.', '') : 0}}</td>
            <td>{{$drainaselimbah6= ($drainasevol != 0) ? number_format($formulir->drainaselimbah_tahap2f/$drainasevol*$enam, 2, '.', '') : 0}}</td>
            <td>{{$drainaselimbah7= ($drainasevol != 0) ? number_format($formulir->drainaselimbah_tahap2g/$drainasevol*$tujuh, 2, '.', '') : 0}}</td>
    ...
    @elseif (Auth::user()->id == $formulir->user_id)
    <!DOCTYPE html>
    <html>
    <head>
    <style>

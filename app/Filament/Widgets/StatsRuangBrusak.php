...
class StatsRuangBrusak extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        $totalTidakisi = $RuangrusakData->whereNull('nilai_akhir')->count();
        $totalRingan=$RuangrusakData->whereNotNull('nilai_akhir')->where('nilai_akhir', '>=', 0)->where('nilai_akhir', '<=', 30)->count();
        ...
        return [
            Stat::make('Belum Diperbarui', $totalTidakisi)
            ->color('success'),
